...
- A middleware (`apps/core/middleware.py`) resolves the current tenant from the request (subdomain / authenticated user's membership) and sets the context var + the Postgres session variable used by RLS.
