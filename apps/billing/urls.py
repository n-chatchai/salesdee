...
urlpatterns = [
    ...
    path(
        "tax-invoices/<int:tax_pk>/debit-note/",
        views.debit_note_create,
        name="debit_note_create",
    ),
    path("debit-notes/", views.debit_notes, name="debit_notes"),
    path("debit-notes/<int:pk>/", views.debit_note_detail, name="debit_note_detail"),
    path("debit-notes/<int:pk>/pdf/", views.debit_note_pdf, name="debit_note_pdf"),
